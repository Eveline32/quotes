...
export class QuotesComponent implements OnInit {
  ...
  quotes:Quote[] = [
    ...
    new Quote (2,'Wendy','Technology…','Technology… the knack of so arranging  that we do not have to experience it.','Max Frisch',new Date(2019,7,14),0,0),
    ...
    new Quote (4,'Beatrice','Communication','Communications tools do not get socially interesting until they get technologically boring.','Clay Shirky',new Date(2019,7,7),0,0),
